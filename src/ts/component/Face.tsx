                    ...
                    faces.map((face) => (
                        <div key={face.id} className="face-item">
                            ...
                            <div className="face-info">
                                <div className="face-info-label">Smiley</div>
                                <div className="face-info-value">{face.smiley}</div>
                                <div className="face-info-label">Color</div>
                                <div className="face-info-value" style={{ color: face.color }}>
                                    {face.color}
                                </div>
                            </div>
                        </div>
